...
public class User {
	...
	public int getUser_id() {// this is our account number as well
		return user_id;
	}
	...
	// public User(long Aadhar_id, String Name, String Fathers_name, String Country,
	// long Mobile_no, String Pan_no) {
